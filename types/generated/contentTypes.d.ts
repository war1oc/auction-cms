...
export interface ApiAuctionAuction extends Schema.CollectionType {
...
export interface ApiBidBid extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    item: Attribute.Relation<'api::bid.bid', 'manyToOne', 'api::item.item'>;
...
export interface ApiItemItem extends Schema.CollectionType {
  ...
  attributes: {
    ...
    startingBid: Attribute.Decimal;
    bids: Attribute.Relation<'api::item.item', 'oneToMany', 'api::bid.bid'>;
    auction: Attribute.Relation<
      'api::item.item',
      'manyToOne',
      'api::auction.auction'
    >;
    minIncrement: Attribute.Decimal;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
